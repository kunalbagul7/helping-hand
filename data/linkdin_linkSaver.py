...
SESSION_FILE  = r"C:\jobs_applyer\backend\data\linkedin_session.json"
INPUT_CSV     = r"C:\jobs_applyer\backend\data\jobs.csv"
OUTPUT_CSV    = r"C:\jobs_applyer\backend\data\jobs_url.csv"
